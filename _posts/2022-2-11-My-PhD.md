...
<p align="center">
  <img alt="img-name" src="{{ site.baseurl }}/images/fig1.png" height="auto" width="600">
    <em>Scales in micromagnetism. a) Atomic scale representation of individual magnetic moments \\(\bm{\mu}_i\\). b) Micromagnetic scale representation of the magnetization vector \\(\bm{M}\\) defining as the sum of all magnetic moments \\(\bm{\mu}_i\\) inside the volume \\(dV\\): \\(\bm{M} = \sum_{i} \bm{\mu}_i/dV\\).</em>
</p>
