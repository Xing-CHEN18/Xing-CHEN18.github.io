...
Actually, It was when I was writing my PhD thesis I noticed the application of FFT in my micormagnetic simulations, I was very surprised about that because FFT is a very old algorithm and I was impressed by this algorithm when I first time learned its work mechanism in the course of Digital Signal Processing in my undergraduate studies. I had the feeling that the past experience can be connected, and we won't know when the impact  
